...
typedef NS_ENUM(NSUInteger, AdbertADInterstitialType) {
    NormalInterstitial, H5Interstitial, VideoInterstitial, BottomVideoInterstitial
};
...
@property(nonatomic, assign) BOOL frequencyLock;
@property(nonatomic, assign) BOOL animateSlideIn;
